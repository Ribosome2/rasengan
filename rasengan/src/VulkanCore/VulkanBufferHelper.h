...
public:
    ...
    inline static void CopyBuffer(VkBuffer & srcBuffer, VkBuffer & dstBuffer, VkDeviceSize size) {
        ...
        allocInfo.commandPool = vkContext->CommandBuffer.GetCommandPool();
        ...
        vkFreeCommandBuffers(device, vkContext->CommandBuffer.GetCommandPool(), 1, &commandBuffer);
    }
};